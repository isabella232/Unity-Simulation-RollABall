...
namespace Unity.Simulation
{
    ...
    public sealed class Manager
    {
        ...
        int _maxRequestStartFramesToWait;
        ...
        public void Shutdown()
        {
            if (!_shutdownRequested)
            {
                ...
                _maxRequestStartFramesToWait = Options.maxRequestStartFramesToWait;
                Update();
            }
        }
        ...
        {
            if (_finalUploadsDone && Interlocked.Add(ref AsyncRequest._insideRequestExecutionCount, 0) == 0)
            {
        ...
        bool AnyRequestsHaveNotStarted()
        {
            ...
            {
                Log.V("Waited for AsyncRequest instances that never started. Continuing with Shutdown.");
                return false;
            }
            else
